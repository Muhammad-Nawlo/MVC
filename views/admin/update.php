...
?>
<section class="mt-2">
    <h1 class=" mt-2 text-center">Udate product</h1>
    <form action="/admin/update-product" method="post" class="needs-validation" novalidate ENCTYPE="multipart/form-data">
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <select name="brand" id="brand"
                        ...
                        <option value=""></option>
                        <option value="Samsung" <?= $data['brand'] === 'Samsung' ? 'selected' : '' ?>>Samsung</option>
                        <option value="Apple" <?= $data['brand'] === 'Apple' ? 'selected' : '' ?>>Apple</option>
                        <option value="Redmi" <?= $data['brand'] === 'Redmi' ? 'selected' : '' ?>>Redmi</option>
                        <option value="Xiaomi" <?= $data['brand'] === 'Xiaomi' ? 'selected' : '' ?>>Xiaomi</option>
                        <option value="Infinix" <?= $data['brand'] === 'Infinix' ? 'selected' : '' ?>>Infinix</option>
                        <option value="Tecno" <?= $data['brand'] === 'Tecno' ? 'selected' : '' ?>>Tecno</option>
                    </select>
